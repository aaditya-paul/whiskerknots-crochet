...
import { Package, ArrowRight, CalendarDays, ShoppingBag } from "lucide-react";
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="text-left sm:text-right">
                      ...
                      <p className="mt-1 inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-leaf-green/20 text-leaf-green">
